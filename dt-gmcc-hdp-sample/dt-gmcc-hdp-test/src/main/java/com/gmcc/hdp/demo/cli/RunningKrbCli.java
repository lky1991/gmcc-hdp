...
public class RunningKrbCli {
    ...
    public void kafkaLearnSampleCli() {
        ...
        if (type.equals("producer")) {
            KafkaKrbProducerDemo kafkaKrbProducerDemo = new KafkaKrbProducerDemo();
            kafkaKrbProducerDemo.producer(topic, broker);
        } else if (type.equals("consumer")) {
            KafkaKrbConsumerDemo kafkaKrbConsumerDemo = new KafkaKrbConsumerDemo();
            kafkaKrbConsumerDemo.consumer(topic);
        }
    }
