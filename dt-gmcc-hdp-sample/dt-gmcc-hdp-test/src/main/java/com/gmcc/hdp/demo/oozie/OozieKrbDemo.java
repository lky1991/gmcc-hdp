...
public class OozieKrbDemo {
    ...
    private AuthOozieClient oozieClient = new AuthOozieClient(HDPSampleConfiguration.OOZIE_URL,"KERBEROS");
    /**
     * @return - jobId
    ...
    public static void main(String[] args) {
        ...
        try {
            OozieKrbDemo client = new OozieKrbDemo();

            Properties properties = new Properties();
            properties.load(new FileInputStream(new File(args[2])));
            properties.setProperty("oozie.authentication.type", "Kerberos");
            properties.setProperty("oozie.service.HadoopAccessorService.kerberos.principal", "oozie/vm2.datatub.com@DATATUB.COM");
