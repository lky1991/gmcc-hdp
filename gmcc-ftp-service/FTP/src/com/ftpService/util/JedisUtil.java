...
/**
* @ClassName: JedisUtil
* @Description: 操作redis数据库的工具类
* @author wally@hudongpai.com
* @date 2016-6-27 上午11:06:35
 */
...
public class JedisUtil {
	...
	public JedisPool getPool() {
		return (JedisPool) SpringContextHolder.getBean("jedisPool");
	}
	...
	public class Sets {
		...
		/**
		 * 将成员从源集合移出放入目标集合， 如果源集合不存在或不包哈指定成员，不进行任何操作，返回0。 否则该成员从源集合上删除，并添加到目标集合；如果目标集合中成员已存在，则只在源集合进行删除。
	...
	public class Hash {
		...
		/**
		 * 根据多个字段，获取对应的value，返回List,如果指定的key不存在,List对应位置为null
		 * @param String    key
	...
	public class Strings {
		...
		/**
		 * 从指定位置开始插入数据，插入的数据会覆盖指定位置以后的数据。例:String str1="123456789",对str1操作后setRange(key,4,0000)，str1="123400009";
		 * @param String      key
		 * @param long        offset
		 * @param String      value
